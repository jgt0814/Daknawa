--DROP USER CHICKEN CASCADE;
--CREATE USER CHICKEN IDENTIFIED BY CHICKEN;
--GRANT CONNECT,RESOURCE TO CHICKEN;
...
CREATE TABLE REPLY_REPORT (
	...
	CONSTRAINT PK_REPLY_REPORT PRIMARY KEY (RR_NO),
	CONSTRAINT FK_MEMBER_TO_REPLY_REPORT_1 FOREIGN KEY (MEMBER_NO) REFERENCES MEMBER (MEMBER_NO),
	CONSTRAINT FK_REPLY_TO_REPLY_REPORT_1 FOREIGN KEY (REPLY_NO) REFERENCES REPLY (REPLY_NO)
);
